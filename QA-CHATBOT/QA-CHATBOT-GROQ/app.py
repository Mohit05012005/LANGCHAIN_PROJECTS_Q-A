...
groq_api_key = os.getenv("MY_KEY_GROQ")

llm = ChatGroq(groq_api_key=groq_api_key,model_name="moonshotai/kimi-k2-instruct-0905")
prompt = ChatPromptTemplate.from_template(    ## two things here : context and question .......
    """
...
user_prompts = st.text_input("Enter your query from the research paper")
